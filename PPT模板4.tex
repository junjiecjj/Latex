\documentclass[8pt]{beamer}	%声明文档类型为beamer幻灯片
\mode <presentation>
...
\setCJKsansfont{WenQuanYi Micro Hei}	%设置中文无衬线字体
\setCJKmonofont{WenQuanYi Micro Hei}	%设置中文等宽字体

\setCJKfamilyfont{song}{WenQuanYi Micro Hei}%自定义字体，可以用来在幻灯片中改变字体
\setCJKfamilyfont{hei}{SimHei}	%自定义字体，可以用来在幻灯片中改变字体
\setCJKfamilyfont{kai}{SimKai}
\setCJKfamilyfont{fs}{WenQuanYi Micro Hei}
...
\title{EAST密度极限破裂数据库的建立及其预测}	%幻灯片标题
\author[陈俊杰]{陈俊杰}
\def\advisor{休息休息}

\institute[中国科学技术大学]{{\normalsize 工程与应用物理系 \\ 中国科学技术大学，物理学院}}%作者单位
%\date{\today}
\date{2019.09.12}
